...
--
-- Database: `thaiherbin_info`
--

-- --------------------------------------------------------

--
-- Stand-in structure for view `btview_category`
--
CREATE TABLE IF NOT EXISTS `btview_category` (
`category_id` int(20) unsigned
,`category_name_th` varchar(150)
,`category_name_en` varchar(150)
,`category_type` varchar(100)
,`category_status` enum('publish','unpublish')
,`category_datecreate` datetime
,`firstnameTH` varchar(200)
,`lastnameTH` varchar(200)
,`title_nameTH` varchar(50)
);
-- --------------------------------------------------------

--
-- Stand-in structure for view `btview_content`
--
CREATE TABLE IF NOT EXISTS `btview_content` (
`content_id` int(20)
...
,`content_createdate` datetime
,`content_lastupdate` datetime
,`content_view` int(20)
,`content_status` enum('publish','unpublish')
,`content_link` varchar(200)
,`officeID` int(20)
,`userID` int(20)
,`officeNameTH` varchar(200)
,`officeNameEN` varchar(200)
,`officeShortname` varchar(30)
,`firstnameTH` varchar(200)
,`lastnameTH` varchar(200)
,`firstnameEN` varchar(200)
,`lastnameEN` varchar(200)
,`title_nameTH` varchar(50)
,`title_nameEN` varchar(50)
,`officeShortnameEN` varchar(30)
);
-- --------------------------------------------------------

--
-- Stand-in structure for view `btview_news`
--
CREATE TABLE IF NOT EXISTS `btview_news` (
`firstnameTH` varchar(200)
,`lastnameTH` varchar(200)
,`officeNameTH` varchar(200)
,`officeNameEN` varchar(200)
...
,`title_nameTH` varchar(50)
,`news_id` int(20)
,`news_categories` varchar(100)
,`news_subject_th` varchar(200)
,`news_subject_en` varchar(200)
,`news_title_th` text
,`news_title_en` text
,`news_content_th` text
,`news_content_en` text
,`news_photo` varchar(200)
,`news_photoslide` varchar(200)
,`news_date` date
,`news_createdate` datetime
,`news_lastupdate` datetime
,`news_view` int(20)
,`news_slide` enum('publish','unpublish')
,`officeID` int(20)
,`userID` int(20)
,`news_order` int(20)
...
--
-- Stand-in structure for view `btview_pages`
--
CREATE TABLE IF NOT EXISTS `btview_pages` (
`firstnameTH` varchar(200)
,`lastnameTH` varchar(200)
,`officeNameTH` varchar(200)
,`officeNameEN` varchar(200)
...
,`title_nameTH` varchar(50)
,`pages_id` int(20)
,`pages_categories` varchar(100)
,`pages_subject_th` varchar(200)
,`pages_subject_en` varchar(200)
,`pages_title_th` text
,`pages_title_en` text
,`pages_content_th` text
,`pages_content_en` text
,`pages_photo` varchar(200)
,`pages_photoslide` varchar(200)
,`pages_date` date
,`pages_createdate` datetime
,`pages_lastupdate` datetime
,`pages_view` int(20)
,`pages_slide` enum('publish','unpublish')
,`officeID` int(20)
,`userID` int(20)
,`pages_order` int(20)
,`pages_link` varchar(200)
,`category_id` int(11)
,`category_name_th` varchar(150)
,`category_name_en` varchar(150)
);
...
--
-- Stand-in structure for view `btview_user`
--
CREATE TABLE IF NOT EXISTS `btview_user` (
`id` int(11)
,`userID` varchar(20)
,`title_id` int(11)
,`firstnameTH` varchar(200)
...
,`paccEmail` varchar(200)
,`personalEmail` varchar(200)
,`telephone` varchar(20)
,`mobile` varchar(20)
,`createdate` datetime
,`profilePicture` varchar(150)
,`userType` enum('user','admin','superadmin','editor')
...
INSERT INTO `bt_category` (`category_id`, `category_name_th`, `category_name_en`, `category_type`, `category_status`, `category_datecreate`, `userID`) VALUES
...
(5, 'Phyto Care (Facial)', 'Phyto Care (Facial)', 'product', 'publish', '2018-02-08 16:36:08', 2);

-- --------------------------------------------------------

--
-- Table structure for table `bt_contactus`
--

CREATE TABLE IF NOT EXISTS `bt_contactus` (
...
--
-- Table structure for table `bt_loginfo`
--

CREATE TABLE IF NOT EXISTS `bt_loginfo` (
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=233 ;

--
-- Dumping data for table `bt_loginfo`
--

INSERT INTO `bt_loginfo` (`log_id`, `log_type`, `log_typeID`, `log_detail`, `log_date`, `log_ip`, `log_user`, `log_user_id`) VALUES
...
(197, 'Content', 1, 'แก้ไข ประวัติความเป็นมา', '2018-02-08 16:10:26', '49.229.194.27', 'admin', 2),
(198, 'Content', 1, 'แก้ไข ประวัติความเป็นมา', '2018-02-08 16:10:59', '49.229.194.27', 'admin', 2),
(199, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:12:22', '49.229.194.27', 'admin', 2),
(200, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:13:26', '49.229.194.27', 'admin', 2),
(201, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:13:46', '49.229.194.27', 'admin', 2),
(202, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:14:36', '49.229.194.27', 'admin', 2),
(203, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:22:30', '49.229.194.27', 'admin', 2),
(204, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:27:59', '49.229.194.27', 'admin', 2),
(205, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:28:26', '49.229.194.27', 'admin', 2),
(206, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-08 16:29:12', '49.229.194.27', 'admin', 2),
(207, 'Career', 0, 'เพิ่มหมวดหมู๋ - Phyto Care (Facial)', '2018-02-08 16:36:08', '49.229.194.27', 'admin', 2),
(208, 'Product', 0, 'เพิ่มผลิตภํณฑ์', '2018-02-08 16:40:36', '49.229.194.27', 'admin', 2),
(209, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:40:52', '49.229.194.27', 'admin', 2),
(210, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:42:45', '49.229.194.27', 'admin', 2),
(211, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:43:35', '49.229.194.27', 'admin', 2),
(212, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:44:34', '49.229.194.27', 'admin', 2),
(213, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:45:18', '49.229.194.27', 'admin', 2),
(214, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:46:59', '49.229.194.27', 'admin', 2),
(215, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:47:43', '49.229.194.27', 'admin', 2),
(216, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:48:37', '49.229.194.27', 'admin', 2),
(217, 'Product', 0, 'แก้ไขผลิตภัณฑ์', '2018-02-08 16:50:03', '49.229.194.27', 'admin', 2),
(218, 'Career', 0, 'แก้ไขตำแหน่งงาน - IT Support', '2018-02-08 17:08:12', '49.229.194.27', 'admin', 2),
(219, 'Content', 1, 'แก้ไข ประวัติความเป็นมา', '2018-02-08 17:12:31', '49.229.194.27', 'admin', 2),
(220, 'Banner', 0, 'Edit banner', '2018-02-12 09:22:01', '182.52.111.200', 'admin', 2),
(221, 'Banner', 0, 'Edit banner', '2018-02-12 09:23:06', '182.52.111.200', 'admin', 2),
(222, 'Banner', 0, 'Edit banner', '2018-02-12 09:23:27', '182.52.111.200', 'admin', 2),
(223, 'Banner', 0, 'Edit banner', '2018-02-12 09:23:42', '182.52.111.200', 'admin', 2),
(224, 'Banner', 0, 'Edit banner', '2018-02-12 09:35:34', '182.52.111.200', 'admin', 2),
(225, 'Content', 2, 'แก้ไข จัดการข้อมูลส่วนท้ายเว็บ ', '2018-02-12 10:17:46', '183.89.108.182', 'admin', 2),
(226, 'Content', 2, 'แก้ไข จัดการข้อมูลส่วนท้ายเว็บ ', '2018-02-12 10:18:22', '183.89.40.136', 'admin', 2),
(227, 'Content', 9, 'แก้ไข สถานที่จัดจำหน่าย ', '2018-02-17 15:24:37', '182.232.14.222', 'vanlop', 1),
(228, 'Content', 8, 'แก้ไข วิจัยพัฒนา/การประกันคุณภาพ ', '2018-02-17 15:26:31', '182.232.14.222', 'vanlop', 1),
(229, 'Content', 7, 'แก้ไข กระบวนการผลิต ', '2018-02-17 15:31:16', '182.232.14.222', 'vanlop', 1),
(230, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-17 15:32:54', '182.232.14.222', 'vanlop', 1),
(231, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-17 15:33:58', '182.232.14.222', 'vanlop', 1),
(232, 'Content', 3, 'แก้ไข วิสัยทัศน์', '2018-02-17 15:34:23', '182.232.14.222', 'vanlop', 1);

-- --------------------------------------------------------

--
-- Table structure for table `bt_media`
--
...
CREATE TABLE IF NOT EXISTS `bt_media` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT AUTO_INCREMENT=24 ;

--
-- Dumping data for table `bt_media`
--

INSERT INTO `bt_media` (`id`, `name`, `media_type`, `filename`, `createdate`, `content_id`, `news_id`) VALUES
...
INSERT INTO `bt_news` (`news_id`, `news_categories`, `news_subject_th`, `news_subject_en`, `news_title_th`, `news_title_en`, `news_content_th`, `news_content_en`, `news_photo`, `news_photoslide`, `news_date`, `news_createdate`, `news_lastupdate`, `news_view`, `news_slide`, `news_order`, `news_link`, `officeID`, `userID`) VALUES
...
--
-- Table structure for table `bt_office`
--

CREATE TABLE IF NOT EXISTS `bt_office` (
...
--
-- Dumping data for table `bt_office`
--

INSERT INTO `bt_office` (`officeID`, `officeNameTH`, `officeNameEN`, `officeShortname`, `officeShortnameEN`) VALUES
(1200, 'herbalshopthailand.com', 'herbalshopthailand.com', 'herbalshopthailand.com', 'herbalshopthailand.com');

-- --------------------------------------------------------

--
-- Table structure for table `bt_pages`
--

CREATE TABLE IF NOT EXISTS `bt_pages` (
...
--
-- Dumping data for table `bt_pages`
--

INSERT INTO `bt_pages` (`pages_id`, `pages_categories`, `pages_subject_th`, `pages_subject_en`, `pages_title_th`, `pages_title_en`, `pages_content_th`, `pages_content_en`, `pages_photo`, `pages_photoslide`, `pages_date`, `pages_createdate`, `pages_lastupdate`, `pages_view`, `pages_slide`, `pages_order`, `pages_link`, `officeID`, `userID`, `category_id`) VALUES
...
(4, 'career', 'IT Support', 'IT Support', '', '', '<p>Duties and Responsibilities:</p>\r\n\r\n<ul>\r\n	<li>Organizing and preparing agendas and papers for board meetings, committees and annual general meeting (AGMs).</li>\r\n	<li>Taking minutes, drafting resolutions and relevant documents.</li>\r\n	<li>Maintaining statutory books, including registers members, directors and secretaries.</li>\r\n	<li>Maintaining database and all other documents in relations to company secretary and investor relations matters.</li>\r\n	<li>Liaising with external regulators and advisers, such as lawyers and auditors.</li>\r\n	<li>Assist team in terms of ensuring department year plan and calendars are being followed and executed as planned.</li>\r\n</ul>', '<p>Duties and Responsibilities:</p>\r\n\r\n<ul>\r\n	<li>Organizing and preparing agendas and papers for board meetings, committees and annual general meeting (AGMs).</li>\r\n	<li>Taking minutes, drafting resolutions and relevant documents.</li>\r\n	<li>Maintaining statutory books, including registers members, directors and secretaries.</li>\r\n	<li>Maintaining database and all other documents in relations to company secretary and investor relations matters.</li>\r\n	<li>Liaising with external regulators and advisers, such as lawyers and auditors.</li>\r\n	<li>Assist team in terms of ensuring department year plan and calendars are being followed and executed as planned.</li>\r\n</ul>', NULL, '', '2017-09-18', '2017-09-25 00:20:06', '2018-02-08 17:08:12', NULL, '', 0, 'IT-Support', 1200, 2, 0),
(6, 'product', 'สารสกัดฟ้าทะลายโจร แคปซูล (ยาแผนโบราณ)', 'สารสกัดฟ้าทะลายโจร แคปซูล (ยาแผนโบราณ)', '', '', '<p>ใบอนุญาตเลขที่ : ฆอ. 1598/2557<br />\r\nชื่อผลิตภัณฑ์&nbsp;&nbsp; : &nbsp;สารสกัดฟ้าทะลายโจร แคปซูล&nbsp;&nbsp;(ยาแผนโบราณ)<br />\r\nส่วนประกอบ&nbsp;&nbsp;&nbsp; :&nbsp; ใน1 แคปซูลประกอบด้วยสารสกัดฟ้าทะลายโจร&nbsp; ซึ่งมีแอนโดรกราโฟไลด์ ไม่ต่ำกว่า 20 มก.<br />\r\nสรรพคุณ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;บรรเทาอาการเจ็บคอ<br />\r\nวิธีใช้&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; รับประทานครั้งละ 1 แคปซูล วันละ 3 ครั้ง หลังอาหาร หรือตามแพทย์สั่ง<br />\r\nขนาดบรรจุ&nbsp;&nbsp;&nbsp; : &nbsp;10x10 แคปซูล/กล่อง</p>', '<p>ใบอนุญาตเลขที่ : ฆอ. 1598/2557<br />\r\nชื่อผลิตภัณฑ์&nbsp;&nbsp; : &nbsp;สารสกัดฟ้าทะลายโจร แคปซูล&nbsp;&nbsp;(ยาแผนโบราณ)<br />\r\nส่วนประกอบ&nbsp;&nbsp;&nbsp; :&nbsp; ใน1 แคปซูลประกอบด้วยสารสกัดฟ้าทะลายโจร&nbsp; ซึ่งมีแอนโดรกราโฟไลด์ ไม่ต่ำกว่า 20 มก.<br />\r\nสรรพคุณ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;บรรเทาอาการเจ็บคอ<br />\r\nวิธีใช้&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; รับประทานครั้งละ 1 แคปซูล วันละ 3 ครั้ง หลังอาหาร หรือตามแพทย์สั่ง<br />\r\nขนาดบรรจุ&nbsp;&nbsp;&nbsp; : &nbsp;10x10 แคปซูล/กล่อง</p>', NULL, '201802081646590.jpg', '2017-11-02', '2017-09-27 00:31:40', '2018-02-08 16:46:59', NULL, '', 0, 'สารสกัดฟ้าทะลายโจร-แคปซูล--ยาแผนโบราณ-', 1200, 2, 2),
(8, 'product', 'ถังเช่า ผสมสารสกัดชะเอม แบบขวด', 'ถังเช่า ผสมสารสกัดชะเอม แบบขวด', '', '', '<p>ชื่อผลิตภัณฑ์ &nbsp;: &nbsp;ถังเช่า ผสมสารสกัดชะเอม<br />\r\nส่วนประกอบ &nbsp; : ผงถังเช่า 500 มก. และสารสกัดชะเอม&nbsp;50&nbsp;มก.<br />\r\nวิธีใช้ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: รับประทานครั้งละ 1-2 แคปซูล วันละ 2 ครั้ง&nbsp;<br />\r\nข้อควรระวัง &nbsp; &nbsp;: เด็กและสตรีมีครรภ์ไม่ควรรับประทาน<br />\r\nการเก็บรักษา &nbsp; : &nbsp; เก็บในที่เย็นและแห้ง<br />\r\nขนาดบรรจุ : &nbsp;60 แคปซูล<br />\r\n<br />\r\nคำเตือน : อ่านคำเตือนในฉลากก่อนบริโภค ไม่มีผลในการป้องกันหรือรักษาโรค</p>', '<p>ชื่อผลิตภัณฑ์ &nbsp;: &nbsp;ถังเช่า ผสมสารสกัดชะเอม<br />\r\nส่วนประกอบ &nbsp; : ผงถังเช่า 500 มก. และสารสกัดชะเอม&nbsp;50&nbsp;มก.<br />\r\nวิธีใช้ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: รับประทานครั้งละ 1-2 แคปซูล วันละ 2 ครั้ง&nbsp;<br />\r\nข้อควรระวัง &nbsp; &nbsp;: เด็กและสตรีมีครรภ์ไม่ควรรับประทาน<br />\r\nการเก็บรักษา &nbsp; : &nbsp; เก็บในที่เย็นและแห้ง<br />\r\nขนาดบรรจุ : &nbsp;60 แคปซูล<br />\r\n<br />\r\nคำเตือน : อ่านคำเตือนในฉลากก่อนบริโภค ไม่มีผลในการป้องกันหรือรักษาโรค</p>', NULL, '201802081645180.jpg', '2017-11-01', '2017-09-27 00:39:59', '2018-02-08 16:45:18', NULL, '', 0, 'ถังเช่า-ผสมสารสกัดชะเอม-แบบขวด', 1200, 2, 1),
(10, 'product', 'ยาเม็ดจันทน์ลีลา', 'ยาเม็ดจันทน์ลีลา', '', '', '<p><strong>ชื่อผลิตภัณฑ์ :&nbsp;</strong>ยาเม็ดจันทน์ลีลา&nbsp;<br />\r\n<strong>สารสำคัญ&nbsp;</strong><strong>:</strong>&nbsp;ใน 1 เม็ด ( ผงยา 500 มิลลิกรัม ) ประกอบด้วย โกฐสอ โกฐเขมา โกฐจุฬาลัมพา แก่นจันทน์เทศ แก่นจันทน์แดง ลูกกระดอม บอระเพ็ด รากปลาไหลเผือก หนักสิ่งละ 60.6 มิลลิกรัม หรือ 4 ส่วน พิมเสน หนัก15.2 มิลิกรัม หรือ 1 ส่วน<br />\r\n<strong>สรรพคุณ&nbsp;</strong><strong>:&nbsp;</strong>แก้ไข้ แก้ตัวร้อน&nbsp;<br />\r\n<strong>รูปแบบ</strong>&nbsp;<strong>:</strong>&nbsp;ยาเม็ด&nbsp;<br />\r\n<strong>วิธีใช้&nbsp;</strong><strong>:</strong>&nbsp;ผู้ใหญ่ ครั้งละ 3-4 เม็ด ทุก 4 ชั่วโมง, เด็กอายุ 6-12 ปี ครั้งละ 1-2 เม็ด ทุก 4 ชั่วโมง<br />\r\n<strong>ขนาดบรรจุ :&nbsp;</strong>30 เม็ด/ขวด<br />\r\n<strong>คำเตือน :&nbsp;</strong>ไม่แนะนำให้ใช้ในผู้ที่สงสัยเป็นไข้เลือดออก, หากใช้ยาเป็นเวลานานเกิน 3 วัน แล้วอาการไม่ดีขึ้น ควรปรึกษาแพทย์</p>', '<p><strong>ชื่อผลิตภัณฑ์ :&nbsp;</strong>ยาเม็ดจันทน์ลีลา&nbsp;<br />\r\n<strong>สารสำคัญ&nbsp;</strong><strong>:</strong>&nbsp;ใน 1 เม็ด ( ผงยา 500 มิลลิกรัม ) ประกอบด้วย โกฐสอ โกฐเขมา โกฐจุฬาลัมพา แก่นจันทน์เทศ แก่นจันทน์แดง ลูกกระดอม บอระเพ็ด รากปลาไหลเผือก หนักสิ่งละ 60.6 มิลลิกรัม หรือ 4 ส่วน พิมเสน หนัก15.2 มิลิกรัม หรือ 1 ส่วน<br />\r\n<strong>สรรพคุณ&nbsp;</strong><strong>:&nbsp;</strong>แก้ไข้ แก้ตัวร้อน&nbsp;<br />\r\n<strong>รูปแบบ</strong>&nbsp;<strong>:</strong>&nbsp;ยาเม็ด&nbsp;<br />\r\n<strong>วิธีใช้&nbsp;</strong><strong>:</strong>&nbsp;ผู้ใหญ่ ครั้งละ 3-4 เม็ด ทุก 4 ชั่วโมง, เด็กอายุ 6-12 ปี ครั้งละ 1-2 เม็ด ทุก 4 ชั่วโมง<br />\r\n<strong>ขนาดบรรจุ :&nbsp;</strong>30 เม็ด/ขวด<br />\r\n<strong>คำเตือน :&nbsp;</strong>ไม่แนะนำให้ใช้ในผู้ที่สงสัยเป็นไข้เลือดออก, หากใช้ยาเป็นเวลานานเกิน 3 วัน แล้วอาการไม่ดีขึ้น ควรปรึกษาแพทย์</p>', NULL, '201802081647434.jpg', '2017-11-01', '2017-09-27 01:10:35', '2018-02-08 16:47:43', NULL, '', 0, 'ยาเม็ดจันทน์ลีลา', 1200, 2, 2),
(9, 'product', 'ถังเช่าผสมสารสกัดชะเอม 3x10''s', 'ถังเช่าผสมสารสกัดชะเอม 3x10''s', '', '', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp;&nbsp;ถังเช่าผสมสารสกัดชะเอม<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: ผงถังเช่า 500 มก. สารสกัดชะเอม 50 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1-2 แคปซูล วันละ 2&nbsp;ครั้ง<br />\r\n<strong>คำเตือน :&nbsp;</strong>เด็กและสตรีมีครรภ์ไม่ควรรับประทาน<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 3 x 10 แคปซูล/กล่อง</p>', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp;&nbsp;ถังเช่าผสมสารสกัดชะเอม<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: ผงถังเช่า 500 มก. สารสกัดชะเอม 50 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1-2 แคปซูล วันละ 2&nbsp;ครั้ง<br />\r\n<strong>คำเตือน :&nbsp;</strong>เด็กและสตรีมีครรภ์ไม่ควรรับประทาน<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 3 x 10 แคปซูล/กล่อง</p>', NULL, '201802081644348.jpg', '2017-11-01', '2017-09-27 00:40:43', '2018-02-08 16:44:34', NULL, '', 0, 'ถังเช่าผสมสารสกัดชะเอม-3x10-s', 1200, 2, 1),
...
(15, 'product', 'กาโนลิน เห็ดหลินจือสกัด แบบขวด', 'กาโนลิน เห็ดหลินจือสกัด แบบขวด', '', '', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp; กาโนลิน เห็ดหลินจือสกัด<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: สารสกัดเห็ดหลินจือ 300 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1 แคปซูล วันละ 1 ครั้ง<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 60 แคปซูล/กล่อง</p>', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp; กาโนลิน เห็ดหลินจือสกัด<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: สารสกัดเห็ดหลินจือ 300 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1 แคปซูล วันละ 1 ครั้ง<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 60 แคปซูล/กล่อง</p>', NULL, '201802081643358.jpg', '2017-11-01', '2017-11-01 11:36:16', '2018-02-08 16:43:35', NULL, '', 0, 'กาโนลิน-เห็ดหลินจือสกัด-แบบขวด', 1200, 2, 1),
(16, 'product', 'ขมิ้นชันแคปซูล', 'ขมิ้นชันแคปซูล', '', '', '<p><strong>ชื่อผลิตภัณฑ์&nbsp;</strong>&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;ขมิ้นชันแคปซูล</p>\r\n\r\n<p><strong>ส่วนประกอบ</strong>&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;ใน 1 แคปซูลประกอบด้วย ผงขมิ้นชันที่จะให้น้ำมันระเหยง่าย 0.02 มล. เคอร์คูมินอยด์ 0.024 กรัม</p>\r\n\r\n<p><strong>วิธีใช้&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;รับประทานครั้งละ 2 แคปซูล วันละ 4 ครั้ง หลังอาหารและก่อนนอน &nbsp;หรือตามแพทย์สั่ง</p>\r\n\r\n<p><strong>คำเตือน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>:</strong>&nbsp;&nbsp;ถ้าอาการดังกล่าวไม่ดีขึ้นภายใน 1-2 สัปดาห์ ควรปรึกษาแพทย์</p>\r\n\r\n<p><strong>การเก็บรักษา &nbsp;&nbsp;</strong><strong>:</strong>&nbsp;เก็บในที่เย็นและแห้ง</p>\r\n\r\n<p><strong>ขนาดบรรจุ&nbsp;&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;10&times;10 แคปซูล/กล่อง</p>', '<p><strong>ชื่อผลิตภัณฑ์&nbsp;</strong>&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;ขมิ้นชันแคปซูล</p>\r\n\r\n<p><strong>ส่วนประกอบ</strong>&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;ใน 1 แคปซูลประกอบด้วย ผงขมิ้นชันที่จะให้น้ำมันระเหยง่าย 0.02 มล. เคอร์คูมินอยด์ 0.024 กรัม</p>\r\n\r\n<p><strong>วิธีใช้&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;รับประทานครั้งละ 2 แคปซูล วันละ 4 ครั้ง หลังอาหารและก่อนนอน &nbsp;หรือตามแพทย์สั่ง</p>\r\n\r\n<p><strong>คำเตือน &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong><strong>:</strong>&nbsp;&nbsp;ถ้าอาการดังกล่าวไม่ดีขึ้นภายใน 1-2 สัปดาห์ ควรปรึกษาแพทย์</p>\r\n\r\n<p><strong>การเก็บรักษา &nbsp;&nbsp;</strong><strong>:</strong>&nbsp;เก็บในที่เย็นและแห้ง</p>\r\n\r\n<p><strong>ขนาดบรรจุ&nbsp;&nbsp;&nbsp;</strong>&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;10&times;10 แคปซูล/กล่อง</p>', NULL, '201802081648374.jpg', '2017-11-01', '2017-11-01 11:41:33', '2018-02-08 16:48:37', NULL, '', 0, 'ขมิ้นชันแคปซูล', 1200, 2, 2),
(17, 'product', 'กาโนลิน เห็ดหลินจือสกัด 3x10''s', 'กาโนลิน เห็ดหลินจือสกัด 3x10''s', '', '', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp; กาโนลิน เห็ดหลินจือสกัด<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: สารสกัดเห็ดหลินจือ 300 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1 แคปซูล วันละ 1 ครั้ง<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 3 x 10 แคปซูล/กล่อง</p>', '<p><strong>ชื่อผลิตภัณฑ์&nbsp; :</strong>&nbsp; กาโนลิน เห็ดหลินจือสกัด<br />\r\n<strong>ส่วนประกอบ&nbsp; &nbsp;</strong>: สารสกัดเห็ดหลินจือ 300 มก.<br />\r\n<strong>วิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;:</strong>&nbsp;รับประทานครั้งล่ะ 1 แคปซูล วันละ 1 ครั้ง<br />\r\n<strong>การเก็บรักษา&nbsp;</strong>&nbsp;&nbsp;<strong>:</strong>&nbsp; &nbsp;เก็บในที่เย็นและแห้ง<br />\r\n<strong>ขนาดบรรจุ :</strong>&nbsp; 3 x 10 แคปซูล/กล่อง</p>', NULL, '201802081642452.jpg', '2017-11-01', '2017-11-01 11:43:33', '2018-02-08 16:42:45', NULL, '', 0, 'กาโนลิน-เห็ดหลินจือสกัด-3x10-s', 1200, 2, 1),
(18, 'product', 'ยาอมมะแว้ง รสบ๊วย (ยาสามัญประจำบ้านแผนโบราณ)', 'ยาอมมะแว้ง รสบ๊วย (ยาสามัญประจำบ้านแผนโบราณ)', '', '', '<p><strong>ใบอนุญาตเลขที่&nbsp;</strong>: ฆท. 1821/2557</p>\r\n\r\n<p>ชื่อผลิตภัณฑ์&nbsp;&nbsp;&nbsp; &nbsp;: &nbsp;&nbsp;ยาอมมะแว้ง รสบ๊วย<br />\r\nส่วนประกอบ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;ลูกมะแว้งต้น ลูกมะแว้งเครือ&nbsp; ใบกะเพราแดง ใบตานหม่อน&nbsp; ใบสวาด หัวขมิ้นอ้อย สารส้ม<br />\r\nสรรพคุณ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;แก้ไอ&nbsp; ขับเสมหะ<br />\r\nวิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;อมครั้งละ 3-5 เม็ด เมื่อมีอาการไอ<br />\r\nการเก็บรักษา&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp; ควรเก็บไว้ในที่แห้ง<br />\r\nขนาดบรรจุ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;20 เม็ด/ซอง&nbsp; 20 ซอง/กล่อง</p>', '<p><strong>ใบอนุญาตเลขที่&nbsp;</strong>: ฆท. 1821/2557</p>\r\n\r\n<p>ชื่อผลิตภัณฑ์&nbsp;&nbsp;&nbsp; &nbsp;: &nbsp;&nbsp;ยาอมมะแว้ง รสบ๊วย<br />\r\nส่วนประกอบ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;ลูกมะแว้งต้น ลูกมะแว้งเครือ&nbsp; ใบกะเพราแดง ใบตานหม่อน&nbsp; ใบสวาด หัวขมิ้นอ้อย สารส้ม<br />\r\nสรรพคุณ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;แก้ไอ&nbsp; ขับเสมหะ<br />\r\nวิธีใช้&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;อมครั้งละ 3-5 เม็ด เมื่อมีอาการไอ<br />\r\nการเก็บรักษา&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp; ควรเก็บไว้ในที่แห้ง<br />\r\nขนาดบรรจุ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;20 เม็ด/ซอง&nbsp; 20 ซอง/กล่อง</p>', NULL, '201802081650030.jpg', '2017-11-01', '2017-11-01 11:44:06', '2018-02-08 16:50:03', NULL, '', 0, 'ยาอมมะแว้ง-รสบ๊วย--ยาสามัญประจำบ้านแผนโบราณ-', 1200, 2, 2),
(19, 'Home-Banner', 'นวัตกรรมสมุนไพรไทย ระดับมาตรฐานสากล', 'นวัตกรรมสมุนไพรไทย ระดับมาตรฐานสากล', '', '', '<p>โดยบริษัทร่วมทุนองค์การเภสัชกรรมซึ่งเป็นรัฐวิสาหกิจในการกำกับดูแลของกระทรวงสาธารณสุข โดยทำการวิจัยและพัฒนาสมุนไพรเพื่อใช้เป็นยาและผลิตภัณฑ์เสริมอาหารอย่างต่อเนื่อง</p>', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s</p>', NULL, '201801090045073.jpg', '0000-00-00', '2018-01-08 23:38:30', '2018-02-12 09:23:06', NULL, 'publish', 0, 'http://www.google.com', 1200, 2, 0),
(20, 'Home-Banner', 'Phyto Gold', 'Phyto Gold', '', '', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s</p>', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s</p>', NULL, '201801090047444.jpg', '0000-00-00', '2018-01-08 23:43:01', '2018-02-12 09:35:34', NULL, 'publish', 0, 'http://www.thaiherbinfo.com/2017/th/product/category/Phytogold', 1200, 2, 0),
(22, 'Home-Banner', 'Phytocare', 'Phytocare', '', '', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s</p>', '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s</p>', NULL, '201801090048210.jpg', '0000-00-00', '2018-01-09 00:00:35', '2018-02-12 09:23:42', NULL, 'unpublish', 0, 'http://www.google.com', 1200, 2, 0),
(23, 'product', 'C.A.S.T.', 'C.A.S.T.', '', '', '<p>C.A.S.T Clear Acne Scar Treat<br />\r\nนวัตกรรมทางเทคโนโลยี สู่สุดยอดสมุนไพร 4 ชนิด<br />\r\nจัดการปัญหาสิว ริ้วรอย และความหมองคล้ำ</p>', '<p>C.A.S.T Clear Acne Scar Treat<br />\r\nนวัตกรรมทางเทคโนโลยี สู่สุดยอดสมุนไพร 4 ชนิด<br />\r\nจัดการปัญหาสิว ริ้วรอย และความหมองคล้ำ</p>', NULL, '201802081640368.jpg', '2018-02-08', '2018-02-08 16:40:36', '2018-02-08 16:40:52', NULL, '', 0, 'C.A.S.T.', 1200, 2, 5);

-- --------------------------------------------------------

--
-- Table structure for table `bt_statview`
--

CREATE TABLE IF NOT EXISTS `bt_statview` (
...
--
-- Dumping data for table `bt_statview`
--

INSERT INTO `bt_statview` (`stat_id`, `stat_year`, `stat_month`, `stat_view`, `officeID`) VALUES
(1, '2560', '07', 9, 1200),
(2, '2560', '08', 96, 1200),
(3, '2560', '09', 954, 1200),
(4, '2560', '10', 525, 1200),
...
--
-- Table structure for table `bt_title`
--

CREATE TABLE IF NOT EXISTS `bt_title` (
...
--
-- Dumping data for table `bt_title`
--

INSERT INTO `bt_title` (`title_id`, `title_nameTH`, `title_nameEN`) VALUES
(1, 'นาย', 'Mr.'),
(2, 'นางสาว', 'Ms.'),
(3, 'นาง', 'Mrs.'),
(4, 'พ.ต.อ.', 'Pol.Col.'),
...
--
-- Table structure for table `bt_translate`
--

CREATE TABLE IF NOT EXISTS `bt_translate` (
...
--
-- Dumping data for table `bt_translate`
--

INSERT INTO `bt_translate` (`translate_id`, `translate_th`, `translate_en`) VALUES
(1, 'ประวัติและความเป็นมา', 'Company Profile'),
(2, 'วิสัยทัศน์', 'Vission'),
(3, 'บทบาทและภารกิจ', 'Mission'),
(4, 'ผู้ถือหุ้น', 'Shareholders'),
(5, 'รายชื่อคณะกรรมการ', 'Board of Directors'),
(6, 'กระบวนการผลิต', 'Production'),
(7, 'วิจัยพัฒนา/การประกันคุณภาพ', 'R&D/Quality Assurance'),
(8, 'ผลิตภัณฑ์สมุนไพรไทย', 'Thai Herbal Products'),
(9, 'ดูรายละเอียดผลิตภัณฑ์', 'View Product Details'),
(10, 'ดูผลิตภัณฑ์ทั้งหมด', 'View all products'),
(11, 'อ่านเพิ่มเติม', 'read more'),
(12, 'ข่าวสารและกิจกรรม', 'News & Events'),
(13, 'อ่านต่อ', 'read more'),
(14, 'อ่านข่าวทั้งหมด', 'read all news'),
(15, 'ส่งข้อความ', 'Send message'),
(16, 'ชื่อ - นามสกุล', 'Fullname'),
(17, 'อีเมล์', 'Email Address'),
(18, 'ข้อความ', 'Message'),
(19, 'สำนักงาน', 'Office'),
(20, 'เบอร์โทรศัพท์', 'Telephone'),
(21, 'โทรสาร', 'Fax'),
(22, 'ตำแหน่งงาน', 'Career Position');
...
INSERT INTO `bt_user` (`id`, `userID`, `title_id`, `firstnameTH`, `lastnameTH`, `firstnameEN`, `lastnameEN`, `username`, `password`, `groupID`, `officeID`, `position`, `paccEmail`, `personalEmail`, `telephone`, `mobile`, `createdate`, `profilePicture`, `userType`, `status`, `userOrder`, `managementOrder`) VALUES
...
--
-- Table structure for table `bt_userlog`
--

CREATE TABLE IF NOT EXISTS `bt_userlog` (
...
--
-- Dumping data for table `bt_userlog`
--

INSERT INTO `bt_userlog` (`login_id`, `login_user`, `login_password`, `login_date`, `login_ip`, `login_status`) VALUES
...
(64, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-02 14:48:54', '118.174.161.76', 'true'),
(65, 'vanlop', '2d1413e78399d9eaaa9cbae7b387be43', '2018-02-04 17:55:20', '49.229.75.56', 'true'),
(66, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-08 14:23:59', '49.229.88.115', 'true'),
(67, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-09 10:53:18', '182.52.111.238', 'true'),
(68, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-12 09:20:00', '182.52.111.200', 'true'),
(69, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-12 10:29:50', '182.52.111.200', 'true'),
(70, 'admin', 'Logout', '2018-02-12 10:35:31', '182.52.111.200', 'true'),
(71, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-12 15:58:31', '182.52.111.200', 'true'),
(72, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-16 10:56:16', '182.52.110.12', 'true'),
(73, 'admin', 'Logout', '2018-02-16 10:56:37', '182.52.110.12', 'true'),
(74, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-16 10:57:01', '182.52.110.12', 'true'),
(75, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-16 11:43:33', '182.52.110.33', 'true'),
(76, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-16 11:44:35', '182.52.110.33', 'true'),
(77, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-16 15:17:35', '182.52.110.33', 'true'),
(78, 'vanlop', '2d1413e78399d9eaaa9cbae7b387be43', '2018-02-17 12:00:56', '182.232.14.222', 'true'),
(79, 'admin', '9bc4035a5fafd48599bfc71fba025b40', '2018-02-17 12:01:05', '182.232.14.222', 'false'),
(80, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-17 12:02:01', '182.232.14.222', 'true'),
(81, 'admin', 'aea4561f8b6fda7b301a804b7b9c0c84', '2018-02-17 12:07:43', '125.24.177.249', 'false'),
(82, 'admin', '25255a1c32d44845ecbfdafecf8535b3', '2018-02-17 12:07:52', '125.24.177.249', 'true'),
(83, 'vanlop', '2d1413e78399d9eaaa9cbae7b387be43', '2018-02-17 15:13:52', '182.232.14.222', 'true');

-- --------------------------------------------------------

--
-- Structure for view `btview_category`
--
DROP TABLE IF EXISTS `btview_category`;

CREATE ALGORITHM=UNDEFINED DEFINER=`thaiherbin_info`@`localhost` SQL SECURITY DEFINER VIEW `btview_category` AS select `bt_category`.`category_id` AS `category_id`,`bt_category`.`category_name_th` AS `category_name_th`,`bt_category`.`category_name_en` AS `category_name_en`,`bt_category`.`category_type` AS `category_type`,`bt_category`.`category_status` AS `category_status`,`bt_category`.`category_datecreate` AS `category_datecreate`,`bt_user`.`firstnameTH` AS `firstnameTH`,`bt_user`.`lastnameTH` AS `lastnameTH`,`bt_title`.`title_nameTH` AS `title_nameTH` from ((`bt_category` join `bt_user` on((`bt_category`.`userID` = `bt_user`.`id`))) join `bt_title` on((`bt_title`.`title_id` = `bt_user`.`title_id`)));

-- --------------------------------------------------------

--
-- Structure for view `btview_content`
--
DROP TABLE IF EXISTS `btview_content`;

CREATE ALGORITHM=UNDEFINED DEFINER=`thaiherbin_info`@`localhost` SQL SECURITY DEFINER VIEW `btview_content` AS select `bt_content`.`content_id` AS `content_id`,`bt_content`.`content_categories` AS `content_categories`,`bt_content`.`content_subject_th` AS `content_subject_th`,`bt_content`.`content_subject_en` AS `content_subject_en`,`bt_content`.`content_title_th` AS `content_title_th`,`bt_content`.`content_title_en` AS `content_title_en`,`bt_content`.`content_detail_th` AS `content_detail_th`,`bt_content`.`content_detail_en` AS `content_detail_en`,`bt_content`.`content_createdate` AS `content_createdate`,`bt_content`.`content_lastupdate` AS `content_lastupdate`,`bt_content`.`content_view` AS `content_view`,`bt_content`.`content_status` AS `content_status`,`bt_content`.`content_link` AS `content_link`,`bt_content`.`officeID` AS `officeID`,`bt_content`.`userID` AS `userID`,`bt_office`.`officeNameTH` AS `officeNameTH`,`bt_office`.`officeNameEN` AS `officeNameEN`,`bt_office`.`officeShortname` AS `officeShortname`,`bt_user`.`firstnameTH` AS `firstnameTH`,`bt_user`.`lastnameTH` AS `lastnameTH`,`bt_user`.`firstnameEN` AS `firstnameEN`,`bt_user`.`lastnameEN` AS `lastnameEN`,`bt_title`.`title_nameTH` AS `title_nameTH`,`bt_title`.`title_nameEN` AS `title_nameEN`,`bt_office`.`officeShortnameEN` AS `officeShortnameEN` from (((`bt_content` join `bt_office` on((`bt_content`.`officeID` = `bt_office`.`officeID`))) join `bt_user` on((`bt_content`.`userID` = `bt_user`.`id`))) join `bt_title` on((`bt_user`.`title_id` = `bt_title`.`title_id`)));

-- --------------------------------------------------------

--
-- Structure for view `btview_news`
--
DROP TABLE IF EXISTS `btview_news`;

CREATE ALGORITHM=UNDEFINED DEFINER=`thaiherbin_info`@`localhost` SQL SECURITY DEFINER VIEW `btview_news` AS select `bt_user`.`firstnameTH` AS `firstnameTH`,`bt_user`.`lastnameTH` AS `lastnameTH`,`bt_office`.`officeNameTH` AS `officeNameTH`,`bt_office`.`officeNameEN` AS `officeNameEN`,`bt_office`.`officeShortname` AS `officeShortname`,`bt_title`.`title_nameTH` AS `title_nameTH`,`bt_news`.`news_id` AS `news_id`,`bt_news`.`news_categories` AS `news_categories`,`bt_news`.`news_subject_th` AS `news_subject_th`,`bt_news`.`news_subject_en` AS `news_subject_en`,`bt_news`.`news_title_th` AS `news_title_th`,`bt_news`.`news_title_en` AS `news_title_en`,`bt_news`.`news_content_th` AS `news_content_th`,`bt_news`.`news_content_en` AS `news_content_en`,`bt_news`.`news_photo` AS `news_photo`,`bt_news`.`news_photoslide` AS `news_photoslide`,`bt_news`.`news_date` AS `news_date`,`bt_news`.`news_createdate` AS `news_createdate`,`bt_news`.`news_lastupdate` AS `news_lastupdate`,`bt_news`.`news_view` AS `news_view`,`bt_news`.`news_slide` AS `news_slide`,`bt_news`.`officeID` AS `officeID`,`bt_news`.`userID` AS `userID`,`bt_news`.`news_order` AS `news_order`,`bt_news`.`news_link` AS `news_link` from (((`bt_news` join `bt_office` on((`bt_news`.`officeID` = `bt_office`.`officeID`))) join `bt_user` on((`bt_news`.`userID` = `bt_user`.`id`))) join `bt_title` on((`bt_title`.`title_id` = `bt_user`.`title_id`)));

-- --------------------------------------------------------

--
-- Structure for view `btview_pages`
--
DROP TABLE IF EXISTS `btview_pages`;

CREATE ALGORITHM=UNDEFINED DEFINER=`thaiherbin_info`@`localhost` SQL SECURITY DEFINER VIEW `btview_pages` AS select `bt_user`.`firstnameTH` AS `firstnameTH`,`bt_user`.`lastnameTH` AS `lastnameTH`,`bt_office`.`officeNameTH` AS `officeNameTH`,`bt_office`.`officeNameEN` AS `officeNameEN`,`bt_office`.`officeShortname` AS `officeShortname`,`bt_title`.`title_nameTH` AS `title_nameTH`,`bt_pages`.`pages_id` AS `pages_id`,`bt_pages`.`pages_categories` AS `pages_categories`,`bt_pages`.`pages_subject_th` AS `pages_subject_th`,`bt_pages`.`pages_subject_en` AS `pages_subject_en`,`bt_pages`.`pages_title_th` AS `pages_title_th`,`bt_pages`.`pages_title_en` AS `pages_title_en`,`bt_pages`.`pages_content_th` AS `pages_content_th`,`bt_pages`.`pages_content_en` AS `pages_content_en`,`bt_pages`.`pages_photo` AS `pages_photo`,`bt_pages`.`pages_photoslide` AS `pages_photoslide`,`bt_pages`.`pages_date` AS `pages_date`,`bt_pages`.`pages_createdate` AS `pages_createdate`,`bt_pages`.`pages_lastupdate` AS `pages_lastupdate`,`bt_pages`.`pages_view` AS `pages_view`,`bt_pages`.`pages_slide` AS `pages_slide`,`bt_pages`.`officeID` AS `officeID`,`bt_pages`.`userID` AS `userID`,`bt_pages`.`pages_order` AS `pages_order`,`bt_pages`.`pages_link` AS `pages_link`,`bt_pages`.`category_id` AS `category_id`,`bt_category`.`category_name_th` AS `category_name_th`,`bt_category`.`category_name_en` AS `category_name_en` from ((((`bt_pages` join `bt_office` on((`bt_pages`.`officeID` = `bt_office`.`officeID`))) join `bt_user` on((`bt_pages`.`userID` = `bt_user`.`id`))) join `bt_title` on((`bt_title`.`title_id` = `bt_user`.`title_id`))) join `bt_category` on((`bt_pages`.`category_id` = `bt_category`.`category_id`)));

-- --------------------------------------------------------

--
-- Structure for view `btview_user`
--
DROP TABLE IF EXISTS `btview_user`;

CREATE ALGORITHM=UNDEFINED DEFINER=`thaiherbin_info`@`localhost` SQL SECURITY DEFINER VIEW `btview_user` AS select `bt_user`.`id` AS `id`,`bt_user`.`userID` AS `userID`,`bt_user`.`title_id` AS `title_id`,`bt_user`.`firstnameTH` AS `firstnameTH`,`bt_user`.`lastnameTH` AS `lastnameTH`,`bt_user`.`firstnameEN` AS `firstnameEN`,`bt_user`.`lastnameEN` AS `lastnameEN`,`bt_user`.`username` AS `username`,`bt_user`.`password` AS `password`,`bt_user`.`groupID` AS `groupID`,`bt_user`.`officeID` AS `officeID`,`bt_user`.`position` AS `position`,`bt_user`.`paccEmail` AS `paccEmail`,`bt_user`.`personalEmail` AS `personalEmail`,`bt_user`.`telephone` AS `telephone`,`bt_user`.`mobile` AS `mobile`,`bt_user`.`createdate` AS `createdate`,`bt_user`.`profilePicture` AS `profilePicture`,`bt_user`.`userType` AS `userType`,`bt_user`.`status` AS `status`,`bt_office`.`officeNameTH` AS `officeNameTH`,`bt_office`.`officeNameEN` AS `officeNameEN`,`bt_office`.`officeShortname` AS `officeShortname`,`bt_title`.`title_nameTH` AS `title_nameTH`,`bt_title`.`title_nameEN` AS `title_nameEN`,`bt_user`.`userOrder` AS `userOrder`,`bt_office`.`officeShortnameEN` AS `officeShortnameEN`,`bt_user`.`managementOrder` AS `managementOrder` from ((`bt_user` join `bt_office` on((`bt_user`.`officeID` = `bt_office`.`officeID`))) join `bt_title` on((`bt_user`.`title_id` = `bt_title`.`title_id`)));
