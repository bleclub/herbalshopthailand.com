<?php
	require 'controllers/front/herb_page.php';
	if($row_pages <= 0 ) {
...
<section id="title_page" class="title_page parallax-container">
        <div class="parallax"><img src="<?php echo $baseUrl; ?>/assets/front_end/images/bg_herb_info.jpg"></div>
        <div class="container">
                <div class="text-left">
					<h1>Herb</h1>
					<p>สมุนไพรไทย</p>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $baseUrl.'/'.$lang; ?>/herblist">Herb</a></li>
