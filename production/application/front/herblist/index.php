...
<?php
    $title = 'สมุนไพรไทย - Herbalshop Thailand';
    $description = 'สมุนไพรไทย - Herbalshop Thailand';
    $keywords = 'Herbalshop Thailand';

	$herblist_selected = "class='selected'"; // Menu selected
...
<section id="title_page" class="title_page parallax-container">
    <div class="parallax"><img src="<?php echo $baseUrl; ?>/assets/front_end/images/bg_herb_title.jpg"></div>
    ...
    <script>
     ...
     <script type="text/javascript">
            $(document).ready(function() {
                ...
                var pagetitle = 'herblist';
                var baseUrl = '<?php echo $baseUrl; ?>';
                var lang = '<?php echo $lang; ?>';
                var total_pages = 8;
                $('#result_news').load("<?php echo $baseUrl; ?>/ajax/fetch_herblist.php", {'page':track_click, 'pagetitle':pagetitle, 'baseUrl':baseUrl, 'lang':lang}, function() {track_click++;}); //initial data to load
                ...
                $(".load_more").click(function (e) { //user clicks on button
                    ...
                    if(track_click <= total_pages) //make sure user clicks are still less than total pages
                    {
                        ...
                        $.post('<?php echo $baseUrl; ?>/ajax/fetch_herblist.php',{'page':track_click, 'pagetitle':pagetitle, 'baseUrl':baseUrl, 'lang':lang}, function(data) {
