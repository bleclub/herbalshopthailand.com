    ...
    <script>
     ...
     <script type="text/javascript">
            $(document).ready(function() {
                ...
                var total_pages = 8;
                $('#result_news').load("<?php echo $baseUrl; ?>/ajax/fetch_product.php", {'page':track_click, 'pagetitle':pagetitle, 'baseUrl':baseUrl}, function() {track_click++;}); //initial data to load
                ...
                $(".load_more").click(function (e) { //user clicks on button
                    ...
                    if(track_click <= total_pages) //make sure user clicks are still less than total pages
                    {
                        ...
                        $.post('<?php echo $baseUrl; ?>/ajax/fetch_product.php',{'page':track_click, 'pagetitle':pagetitle, 'baseUrl':baseUrl}, function(data) {
