...
$title = "Edit Banner - แก้ไขแบรนเนอร์";
$menu_banner = "active";
...
$option_pw = array(
        "table" => "btview_pages",
        "condition" => "pages_id='{$_GET['id']}' AND pages_categories='Home-Banner'"
 );
...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/banner/retEDIT" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                            <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ชื่อภาพ" name="pages_subject_th" value="<?php echo $rs_pw['pages_subject_th'];?>" required>
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control"  placeholder="Photo Name" name="pages_subject_en" value="<?php echo $rs_pw['pages_subject_en'];?>" required>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo $rs_pw['pages_link']; ?>"  placeholder="Link (Exp. http://www.yourlink.com)" name="pages_link" required>   
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
              		  ...
              		  <div class="form-group" style="float:left; border:1px solid #CACACA; padding:10px;">
                              <img src="<?php echo $baseUrl; ?>/upload/banner/<?php echo $rs_pw['pages_photoslide']; ?>" width="375"><br>
