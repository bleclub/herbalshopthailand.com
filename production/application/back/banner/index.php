...
$sql_pages = "select * from btview_pages where pages_categories = 'Home-Banner' order by pages_createdate desc";
        	...
        	<div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools pull-right">
                	<a href="<?php echo $baseUrl;?>/back/banner/add" class="btn btn-box-tool"><i class="fa fa-plus"></i> Add new</a>
                ...
                <div class="box-body" id="table-data">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                      <td><img src="<?php echo $baseUrl."/upload/banner/".$rs_pages['pages_photoslide']; ?>" alt="" width="100"></td>
                        <td><?php echo dateFormat($rs_pages['pages_createdate']); ?></td>
                        <td><?php echo $rs_pages['pages_subject_th']; ?></td>
                        <td><?php echo $rs_pages['title_nameTH'].' '.$rs_pages['firstnameTH'].' '.$rs_pages['lastnameTH']; ?></td>
                        <td>
                        	<a href="<?php echo $baseUrl."/back/banner/edit/".$rs_pages['pages_id']; ?>"><i class="fa fa-edit fa-1x"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-outline" href="<?php echo $baseUrl."/back/banner/delete/".$rs_pages['pages_id']; ?>">Confirm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
