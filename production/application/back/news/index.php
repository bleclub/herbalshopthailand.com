        	...
        	<div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools pull-right">
                	<a href="<?php echo $baseUrl;?>/back/news/add" class="btn btn-box-tool"><i class="fa fa-plus"></i> เพิ่มหัวข้อข่าว</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                        	<a href="<?php echo $baseUrl; ?>/back/news/edit/<?php echo $rs_news['news_id']; ?>"><i class="fa fa-edit fa-1x"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-outline" href="<?php echo $baseUrl."/back/news/delete/".$rs_news['news_id']; ?>">Confirm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
