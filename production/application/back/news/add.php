...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/news/retADD" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                            <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ชื่อข่าว" name="news_subject_th" required>
                              <input type="hidden" name="news_categories" value="<?php echo $news_type; ?>">
                            </div>
                            <div class="form-group">
                              <textarea placeholder="หัวข้อข่าว" rows="3" class="form-control" name="news_title_th" required></textarea>
                            </div>
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        ...
                        <div class="form-group">
                          	<textarea placeholder="Title" rows="3" class="form-control" name="news_title_en" required></textarea>
                        </div>
                        <div class="form-group">
                        	<p>Content</p>
