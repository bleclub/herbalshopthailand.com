...
if($_SESSION[_ss . 'levelaccess'] == 'superadmin'){
	...
	$sql_pages = "select * from btview_pages where pages_categories = '$pages_type' and officeID = '".$_SESSION[_ss . 'officeID']."' order by pages_createdate desc";
}
        	...
        	<div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools pull-right">
                	<a href="<?php echo $baseUrl;?>/back/article/add" class="btn btn-box-tool"><i class="fa fa-plus"></i> เพิ่มบทความ</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php if($rs_pages['pages_subject_th'] <> "") { echo mb_substr($rs_pages['pages_subject_th'], 0,60, "UTF-8")."..."; } else { echo mb_substr($rs_pages['pages_subject_en'], 0,60, "UTF-8")."...";  } ?></td>
                        <td><?php echo $rs_pages['title_nameTH'].' '.$rs_pages['firstnameTH'].' '.$rs_pages['lastnameTH']; ?></td>
                        <td><?php echo $rs_pages['pages_view']; ?></td>
                        <td>
                        	<a href="<?php echo $baseUrl; ?>/back/article/edit/<?php echo $rs_pages['pages_id']; ?>"><i class="fa fa-edit fa-1x"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-outline" href="<?php echo $baseUrl."/back/article/delete/".$rs_pages['pages_id']; ?>">Confirm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
