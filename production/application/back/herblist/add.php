      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Add herb list</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/herblist/retADD" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                            <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ชื่อสมุนไพร" name="pages_subject_th" required>   
                              <input type="hidden" name="pages_categories" value="<?php echo $pages_type; ?>">
                            </div>
                            <!-- <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ลิงค์สินค้า" name="pages_link" required>                              
                            </div> -->
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control"  placeholder="Herb Name" name="pages_subject_en" required>
                        </div>
                        <!-- <div class="form-group">
