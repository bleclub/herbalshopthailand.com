...
$pages_type = $_GET['url'];
$title = "Edit herb list - แก้ไขรายละเอียสมุนไพร";
...
$option_pw = array(
        "table" => "btview_pages",
        "condition" => "pages_id='{$_GET['id']}' AND pages_categories='herblist'"
 );
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Herb list</li>
            <li class="active">Edit herb</li>
          </ol>
        </section>
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/herblist/retEDIT" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                            <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ชื่อสมุนไพร" name="pages_subject_th" value="<?php echo $rs_pw['pages_subject_th'];?>" required>
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control"  placeholder="Herb Name" name="pages_subject_en" value="<?php echo $rs_pw['pages_subject_en'];?>" required>
                        </div>
                        <!-- <div class="form-group">
              		  ...
              		  <div class="form-group" style="float:left; border:1px solid #CACACA; padding:10px;">
                              <img src="<?php echo $baseUrl; ?>/upload/herblist/<?php echo $rs_pw['pages_photoslide']; ?>" width="375"><br>
                              <label for="exampleInputFile">Picture</label>
                              <input type="file" name="image" id="exampleInputFile">
                              <p class="help-block">Browse your photo and recommended sizing: 900 x 663px</p>
                      </div> 
