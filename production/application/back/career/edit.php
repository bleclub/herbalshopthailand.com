...
$pages_type = $_GET['url'];
$title = "Edit career - แก้ไขตำแหน่งงาน";
$menu_career = "active";
...
$option_pw = array(
        "table" => "btview_pages",
        "condition" => "pages_id='{$_GET['id']}' AND pages_categories='career'"
 );
...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/career/retEDIT" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                            <div class="form-group">
                              <input type="text" class="form-control"  placeholder="ชื่อตำแหน่งงาน" name="pages_subject_th" value="<?php echo $rs_pw['pages_subject_th'];?>" required>
