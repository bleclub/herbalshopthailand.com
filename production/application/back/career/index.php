...
$pages_type = $_GET['url'];
if($pages_type == "career"){
	$title = 'Career - ตำแหน่งงาน';
	$menu_career = "active";
} else { 
        	...
        	<div class="box">
                <div class="box-header">
                  ...
                  <div class="box-tools pull-right">
                	<a href="<?php echo $baseUrl;?>/back/career/add" class="btn btn-box-tool"><i class="fa fa-plus"></i> เพิ่มตำแหน่งงาน</a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                        	<a href="<?php echo $baseUrl; ?>/back/career/edit/<?php echo $rs_pages['pages_id']; ?>"><i class="fa fa-edit fa-1x"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a role="button" class="btn btn-outline" href="<?php echo $baseUrl."/back/career/delete/".$rs_pages['pages_id']; ?>">Confirm</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
