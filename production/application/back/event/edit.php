...
$option_pw = array(
        "table" => "btview_news",
        "condition" => "news_id='{$_GET['id']}' AND news_categories='event'"
 );
...
<!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- form start -->
           <form role="form" id="registration-form" action="<?php echo $baseUrl; ?>/back/event/retEDIT" method="post" enctype="multipart/form-data">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
              		 <!-- Custom Tabs -->
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control"  placeholder="Event Name" name="news_subject_en" value="<?php echo $rs_pw['news_subject_en'];?>" required>
                        </div>
                        <div class="form-group">
                          	<textarea placeholder="Event Title" rows="3" class="form-control" name="news_title_en" required><?php echo $rs_pw['news_title_en']; ?></textarea>
                        </div>
                        <div class="form-group">
                        	<p>Event Detail</p>
                        	<textarea id="contentEN" name="news_content_en" rows="15" cols="80"><?php echo $rs_pw['news_content_en']; ?></textarea>
                        </div>
                    </div>
                 </div>
                  </div><!-- /.tab-pane -->
