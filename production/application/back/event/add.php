              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="row">
                  	<div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control"  placeholder="Event Name" name="news_subject_en" required>
                        </div>
                        <div class="form-group">
                          	<textarea placeholder="Event Title" rows="3" class="form-control" name="news_title_en" required></textarea>
                        </div>
                        <div class="form-group">
                        	<p>Event Detail</p>
